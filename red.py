...
def main():
    ...
    if params.run:
        ...
        os.system('docker-compose up --scale redscan-nmapservice=5 --scale redscan-nuclei-cve=5 --scale redscan-nuclei-exposedpanels=5 --scale redscan-nuclei-exposure=5 --scale redscan-nuclei-misconfiguration=5 --scale redscan-nuclei-miscellaneous=5 --scale redscan-nuclei-technologies=5 --scale redscan-amass=3 --scale redscan-masscan=2 -d')
