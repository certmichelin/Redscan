...
public class ScanApplication {
  ...
  public void receiveMessage(String message) {
    ...
    try {
      ...
      StreamGobbler streamGobbler = osCommandExecutor.execute(String.format("amass enum -d %s -brute -w /wordlists/deepmagic.com-prefixes-top50000.txt -nolocaldb", masterDomain.getName()));
