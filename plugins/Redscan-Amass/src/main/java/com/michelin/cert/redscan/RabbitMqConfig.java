...
public class RabbitMqConfig {
  ...
  /**
   * QUEUE_MASTER_DOMAINS.
   */
  public static final String QUEUE_MASTER_DOMAINS = "com.michelin.cert.amass.masterdomains";
  ...
  public Declarables fanoutBindings() {
    Queue queue = new Queue(QUEUE_MASTER_DOMAINS, true);
